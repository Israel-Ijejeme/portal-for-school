...
VALUES ('Admin User', 'admin@school.edu', '$2y$10$RWGwBimqHR6n412JKFcGKu0ttgHm490e76/OtyZCHuyifOu9czUtq', 1, 1, 35);

-- Insert teachers
-- Password: teacher123 (hashed)
INSERT INTO users (full_name, email, password, user_type_id, department_id, age)
VALUES 
('John Doe', 'john.doe@school.edu', '$2y$10$PUcvztJDFosuFK5bFqcRJONZaYjjcdI00WvBMqcW6x1XCOfnO4eKW', 2, 1, 40),
...
INSERT INTO users (full_name, email, password, user_type_id, department_id, age)
VALUES 
('Emma Wilson', 'emma.wilson@school.edu', '$2y$10$sTB9/axUYyW7dp05XJks6OLhQBus74KIsV/VpbfW8ROVLZ06MEmGO', 3, 1, 22),
